...
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/Adityaseller02")],
        ]
    )
...
async def plan(client, message):
    plan_text = (
        "💰 **Premium Price**: Starting from  199rs for 1 months 😇accepted via **Upi** to purchase contact @Adityaseller02 (terms and conditions apply).\n"
